...
import com.helpeachother.secretcode.extra.model.PharmacySearch;
...
public class ApiExtraController {
    ...
    public ResponseEntity<?> pharmacy(@RequestBody PharmacySearch pharmacySearch) {
        ...
        String url = String.format("http://apis.data.go.kr/B552657/ErmctInsttInfoInqireService/getParmacyListInfoInqire?serviceKey=%s", apiKey);
